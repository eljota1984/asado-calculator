...
export default function Home() {
  ...
  <div className="text-center">
    ...
    <p className="mx-auto mt-3 max-w-xl text-sm text-zinc-400 md:text-base">
      ...
      y descarga un resumen listo para comprar.
    </p>
  </div>
</section>
        {/* <section className="rounded-2xl bg-zinc-900 p-6 shadow-lg">
          ...
          <p className="mt-2 text-center text-sm text-zinc-400">
            Ingresa personas y selecciona productos para el asado
          </p>
        </section> */}
...
<button
  onClick={irAResumen}
  className="group w-full rounded-2xl bg-red-600 px-5 py-4 text-left shadow-lg transition hover:bg-red-700"
>
...
<p className="text-sm text-red-100">
  Ver dashboard, costos estimados y descargar PDF
</p>
      
    
    </div>

    <span className="text-2xl text-white transition group-hover:translate-x-1">
      →
    </span>
  </div>
</button>
